...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsJourneysLineApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneysLineApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaWebV4ModelsJourneysLineApiModel(string name = default(string), string backgroundColor = default(string), string foregroundColor = default(string), string borderColor = default(string), VTApiPlaneraResaCoreModelsTransportMode? transportMode = default(VTApiPlaneraResaCoreModelsTransportMode?), VTApiPlaneraResaCoreModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaCoreModelsTransportSubMode?), string shortName = default(string), string designation = default(string), bool isWheelchairAccessible = default(bool))
        {
            this.Name = name;
