...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsTimeValidityApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsTimeValidityApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaCoreModelsTimeValidityType? Type { get; set; }

        /// <summary>
        /// Gets or Sets Unit
        /// </summary>
        [DataMember(Name = "unit", EmitDefaultValue = false)]
        public VTApiPlaneraResaCoreModelsTimeValidityUnit? Unit { get; set; }
        /// <summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsTimeValidityApiModel(VTApiPlaneraResaCoreModelsTimeValidityType? type = default(VTApiPlaneraResaCoreModelsTimeValidityType?), int? amount = default(int?), VTApiPlaneraResaCoreModelsTimeValidityUnit? unit = default(VTApiPlaneraResaCoreModelsTimeValidityUnit?), string fromDate = default(string), string toDate = default(string), string fromDateTime = default(string), string toDateTime = default(string))
        {
            this.Type = type;
            this.Amount = amount;
            this.Unit = unit;
