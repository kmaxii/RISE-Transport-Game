...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaWebV4ModelsPositionsLineDetailsApiModel(string name = default(string), string backgroundColor = default(string), string foregroundColor = default(string), string borderColor = default(string), VTApiPlaneraResaCoreModelsTransportMode? transportMode = default(VTApiPlaneraResaCoreModelsTransportMode?), VTApiPlaneraResaCoreModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaCoreModelsTransportSubMode?))
        {
            this.Name = name;
