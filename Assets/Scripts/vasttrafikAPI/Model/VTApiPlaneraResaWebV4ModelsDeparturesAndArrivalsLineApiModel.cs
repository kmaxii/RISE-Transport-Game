...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineApiModel(string gid = default(string), string name = default(string), string shortName = default(string), string designation = default(string), string backgroundColor = default(string), string foregroundColor = default(string), string borderColor = default(string), VTApiPlaneraResaCoreModelsTransportMode? transportMode = default(VTApiPlaneraResaCoreModelsTransportMode?), VTApiPlaneraResaCoreModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaCoreModelsTransportSubMode?), bool isWheelchairAccessible = default(bool))
        {
            this.Gid = gid;
            this.Name = name;
