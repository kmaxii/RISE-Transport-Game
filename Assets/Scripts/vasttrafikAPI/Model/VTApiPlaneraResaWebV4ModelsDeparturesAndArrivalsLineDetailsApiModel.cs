...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsLineDetailsApiModel(string name = default(string), string backgroundColor = default(string), string foregroundColor = default(string), string borderColor = default(string), VTApiPlaneraResaCoreModelsTransportMode? transportMode = default(VTApiPlaneraResaCoreModelsTransportMode?), VTApiPlaneraResaCoreModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaCoreModelsTransportSubMode?))
        {
            this.Name = name;
