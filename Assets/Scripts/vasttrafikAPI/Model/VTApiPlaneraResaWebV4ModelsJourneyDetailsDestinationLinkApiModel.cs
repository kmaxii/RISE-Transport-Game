...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaCoreModelsTransportMode? TransportMode { get; set; }

        /// <summary>
        /// Gets or Sets TransportSubMode
        /// </summary>
        [DataMember(Name = "transportSubMode", EmitDefaultValue = false)]
        public VTApiPlaneraResaCoreModelsTransportSubMode? TransportSubMode { get; set; }
        /// <summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsDestinationLinkApiModel(VTApiPlaneraResaCoreModelsTransportMode? transportMode = default(VTApiPlaneraResaCoreModelsTransportMode?), VTApiPlaneraResaCoreModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaCoreModelsTransportSubMode?), VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel origin = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel), VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel destination = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel), List<VTApiPlaneraResaCoreModelsNote> notes = default(List<VTApiPlaneraResaCoreModelsNote>), int? distanceInMeters = default(int?), string plannedDepartureTime = default(string), string plannedArrivalTime = default(string), int? plannedDurationInMinutes = default(int?), string estimatedDepartureTime = default(string), string estimatedArrivalTime = default(string), int? estimatedDurationInMinutes = default(int?), int? estimatedNumberOfSteps = default(int?), List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel> linkCoordinates = default(List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel>), List<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel> segments = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel>))
        {
        ...
        public List<VTApiPlaneraResaCoreModelsNote> Notes { get; set; }
