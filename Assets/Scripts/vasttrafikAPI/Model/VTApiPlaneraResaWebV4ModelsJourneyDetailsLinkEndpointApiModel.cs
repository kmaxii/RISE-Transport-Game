...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel>, IValidatableObject
    {
        ...
        public VTApiPlaneraResaCoreModelsLocationType LocationType { get; set; }
        /// <summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel(string gid = default(string), string name = default(string), VTApiPlaneraResaCoreModelsLocationType locationType = default(VTApiPlaneraResaCoreModelsLocationType), double? latitude = default(double?), double? longitude = default(double?), string plannedTime = default(string), string estimatedTime = default(string), List<VTApiPlaneraResaCoreModelsNote> notes = default(List<VTApiPlaneraResaCoreModelsNote>))
        {
