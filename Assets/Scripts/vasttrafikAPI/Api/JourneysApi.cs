...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IJourneysApiSync : IApiAccessor
    {
        ...
        VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel JourneysDetailsReferenceDetailsGet(string detailsReference, List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>? includes = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>?), List<int>? channelIds = default(List<int>?), List<int>? productTypes = default(List<int>?), List<VTApiPlaneraResaCoreModelsTravellerCategory>? travellerCategories = default(List<VTApiPlaneraResaCoreModelsTravellerCategory>?), int operationIndex = 0);
        ...
        ApiResponse<VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel> JourneysDetailsReferenceDetailsGetWithHttpInfo(string detailsReference, List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>? includes = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>?), List<int>? channelIds = default(List<int>?), List<int>? productTypes = default(List<int>?), List<VTApiPlaneraResaCoreModelsTravellerCategory>? travellerCategories = default(List<VTApiPlaneraResaCoreModelsTravellerCategory>?), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="varRef">The reconstruction reference. A reconstructionReference is valid as long as the original journey search is valid.</param>
        /// <param name="includeOccupancy">Includes occupancy in journey. (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel</returns>
        VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel JourneysReconstructGet(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0);
        ...
        ApiResponse<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel> JourneysReconstructGetWithHttpInfo(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IJourneysApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel> JourneysDetailsReferenceDetailsGetAsync(string detailsReference, List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>? includes = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>?), List<int>? channelIds = default(List<int>?), List<int>? productTypes = default(List<int>?), List<VTApiPlaneraResaCoreModelsTravellerCategory>? travellerCategories = default(List<VTApiPlaneraResaCoreModelsTravellerCategory>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel>> JourneysDetailsReferenceDetailsGetWithHttpInfoAsync(string detailsReference, List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>? includes = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>?), List<int>? channelIds = default(List<int>?), List<int>? productTypes = default(List<int>?), List<VTApiPlaneraResaCoreModelsTravellerCategory>? travellerCategories = default(List<VTApiPlaneraResaCoreModelsTravellerCategory>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns journeys matching the specified search parameters.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<VTApiPlaneraResaWebV4ModelsJourneysGetJourneysResponse> JourneysGetAsync(string? originGid = default(string?), string? originName = default(string?), double? originLatitude = default(double?), double? originLongitude = default(double?), string? destinationGid = default(string?), string? destinationName = default(string?), double? destinationLatitude = default(double?), double? destinationLongitude = default(double?), DateTime? dateTime = default(DateTime?), VTApiPlaneraResaCoreModelsDateTimeRelatesToType? dateTimeRelatesTo = default(VTApiPlaneraResaCoreModelsDateTimeRelatesToType?), string? paginationReference = default(string?), int? limit = default(int?), List<VTApiPlaneraResaWebV4ModelsJourneyTransportMode>? transportModes = default(List<VTApiPlaneraResaWebV4ModelsJourneyTransportMode>?), List<VTApiPlaneraResaWebV4ModelsJourneyTransportSubMode>? transportSubModes = default(List<VTApiPlaneraResaWebV4ModelsJourneyTransportSubMode>?), bool? onlyDirectConnections = default(bool?), bool? includeNearbyStopAreas = default(bool?), long? viaGid = default(long?), string? originWalk = default(string?), string? destWalk = default(string?), string? originBike = default(string?), string? destBike = default(string?), string? totalBike = default(string?), string? originCar = default(string?), string? destCar = default(string?), string? originPark = default(string?), string? destPark = default(string?), int? interchangeDurationInMinutes = default(int?), bool? includeOccupancy = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel> JourneysReconstructGetAsync(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel>> JourneysReconstructGetWithHttpInfoAsync(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Returns a time interval for when journey data is available.
        /// </summary>
        /// <remarks>
    ...
    public partial class JourneysApi : IJourneysApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel</returns>
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel JourneysDetailsReferenceDetailsGet(string detailsReference, List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>? includes = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>?), List<int>? channelIds = default(List<int>?), List<int>? productTypes = default(List<int>?), List<VTApiPlaneraResaCoreModelsTravellerCategory>? travellerCategories = default(List<VTApiPlaneraResaCoreModelsTravellerCategory>?), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsJourneyDetailsJourneyDetailsApiModel>> JourneysDetailsReferenceDetailsGetWithHttpInfoAsync(string detailsReference, List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>? includes = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsIncludeType>?), List<int>? channelIds = default(List<int>?), List<int>? productTypes = default(List<int>?), List<VTApiPlaneraResaCoreModelsTravellerCategory>? travellerCategories = default(List<VTApiPlaneraResaCoreModelsTravellerCategory>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'detailsReference' is set
            if (detailsReference == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel</returns>
        public VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel JourneysReconstructGet(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel> localVarResponse = JourneysReconstructGetWithHttpInfo(varRef, includeOccupancy);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel</returns>
        public Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel> JourneysReconstructGetWithHttpInfo(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'varRef' is set
            if (varRef == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'varRef' when calling JourneysApi->JourneysReconstructGet");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel</returns>
        public async System.Threading.Tasks.Task<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel> JourneysReconstructGetAsync(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel> localVarResponse = await JourneysReconstructGetWithHttpInfoAsync(varRef, includeOccupancy, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsJourneysJourneyApiModel>> JourneysReconstructGetWithHttpInfoAsync(string varRef, bool? includeOccupancy = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'varRef' is set
            if (varRef == null)
            {
