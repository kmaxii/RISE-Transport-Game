...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ILocationsApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse</returns>
        VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse LocationsByTextGet(string q, List<VTApiPlaneraResaWebV4ModelsLocationByTextType>? types = default(List<VTApiPlaneraResaWebV4ModelsLocationByTextType>?), int? limit = default(int?), int? offset = default(int?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse</returns>
        ApiResponse<VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse> LocationsByTextGetWithHttpInfo(string q, List<VTApiPlaneraResaWebV4ModelsLocationByTextType>? types = default(List<VTApiPlaneraResaWebV4ModelsLocationByTextType>?), int? limit = default(int?), int? offset = default(int?), int operationIndex = 0);
    ...
    public partial class LocationsApi : ILocationsApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse> localVarResponse = LocationsByCoordinatesGetWithHttpInfo(latitude, longitude, radiusInMeters, types, limit, offset);
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse> localVarResponse = await LocationsByCoordinatesGetWithHttpInfoAsync(latitude, longitude, radiusInMeters, types, limit, offset, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse</returns>
        public VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse LocationsByTextGet(string q, List<VTApiPlaneraResaWebV4ModelsLocationByTextType>? types = default(List<VTApiPlaneraResaWebV4ModelsLocationByTextType>?), int? limit = default(int?), int? offset = default(int?), int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse> localVarResponse = LocationsByTextGetWithHttpInfo(q, types, limit, offset);
            return localVarResponse.Data;
        }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<VTApiPlaneraResaWebV4ModelsLocationsGetLocationsResponse> localVarResponse = await LocationsByTextGetWithHttpInfoAsync(q, types, limit, offset, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
