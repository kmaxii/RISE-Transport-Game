...
public class Mission : ScriptableObject
{
    ...
    [Tooltip("If the task is dependent on another task")] 
    [SerializeField] private bool isChainedTask;
    [SerializeField] private Mission parentMission;          // Visibility managed in custom editor
    [Header("Successful")]
    [Tooltip("The money amount change after mission. Use - to make it go down")] 
    [SerializeField] private int moneyReward;
    [Tooltip("The stress amount change after mission. Use - to make it go down")] 
    ...
    [Tooltip("The stress change on failure. Use - to make it go down")] 
    [SerializeField] private int stressPunishment;
    [Tooltip("The comfort change on failure. Use - to make it go down")] 
    [SerializeField] private int comfortPunishment;
